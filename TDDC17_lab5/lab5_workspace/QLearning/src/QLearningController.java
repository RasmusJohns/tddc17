	...
	public void tick(int currentTime) {
		...
		if (!paused) {
			...
			if (previous_state != null) {
				...
				Double Qvalue = Qtable.get(prev_stateaction) + alpha(Ntable.get(prev_stateaction)) * (previous_reward + gamma * getMaxActionQValue(new_state) - Qtable.get(prev_stateaction));
